...
const SECTION_AUDIO := "res://ui/MainMenu/scenes/SettingsAudio.tscn"
const SECTION_VIDEO := "res://ui/MainMenu/scenes/SettingsVideo.tscn"
const SECTION_NETWORK := "res://ui/MainMenu/scenes/SettingsNetwork.tscn"
const SECTION_CONTROLS := "res://ui/MainMenu/scenes/SettingsControls.tscn"
