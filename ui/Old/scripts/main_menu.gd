...
func _on_create_room_pressed():
	...
	if not is_inside_tree():
		return
	get_tree().change_scene_to_file("res://ui/Old/scenes/CreateRoom.tscn")
...
func _on_join_room_pressed():
	...
	if not is_inside_tree():
		return
	get_tree().change_scene_to_file("res://ui/Old/scenes/JoinRoom.tscn")


func _on_options_pressed():
	AudioManager.play_sfx_ui(SfxId.SELECT)
	get_tree().change_scene_to_file("res://ui/Old/scenes/Settings.tscn")
