# res://scripts/abilities/kris/kris_act.gd
# ============================================================
...
func _activate_act(player_node: Node, data: AbilityData, direction: Vector2) -> void:
...
func _activate_counter(player_node: Node, data: AbilityData) -> void:
	var caster_id: int = player_node.get_multiplayer_authority()
...
#   var act_script = load("res://scripts/abilities/kris/kris_act.gd")
